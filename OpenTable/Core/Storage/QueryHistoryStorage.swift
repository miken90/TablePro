...
final class QueryHistoryStorage {
    ...
    private let queue = DispatchQueue(label: "com.opentable.queryhistory", qos: .utility)
    ...
    private func setupDatabase() {
        ...
        try? fileManager.createDirectory(at: openTableDir, withIntermediateDirectories: true)
        
        let dbPath = openTableDir.appendingPathComponent("query_history.db").path
