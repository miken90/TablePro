...
describe('B2 — text-muted is content-free', () => {
  ...
  const ALLOWED: Array<{ file: string; line: number; reason: string }> = [
    ...
    { file: '../components/ai/ai-chat-panel.tsx', line: 71, reason: 'icon-only close button' },
    { file: '../components/ai/ai-chat-panel.tsx', line: 83, reason: 'decorative Sparkles icon' },
    ...
    { file: '../components/editor/EditorTabBar.tsx', line: 152, reason: 'icon-only new-tab button' },
    ...
    { file: '../components/history/HistoryPanel.tsx', line: 98, reason: 'decorative Clock icon' },
    { file: '../components/history/HistoryPanel.tsx', line: 104, reason: 'icon-only clear-all button, hover to red (semantic danger)' },
    { file: '../components/history/HistoryPanel.tsx', line: 112, reason: 'icon-only close button' },
    { file: '../components/history/HistoryPanel.tsx', line: 158, reason: 'icon-only copy button, hover to blue (semantic)' },
    { file: '../components/history/HistoryPanel.tsx', line: 172, reason: 'icon-only delete button, hover to red (semantic danger)' },
    { file: '../components/inspector/inspector-panel.tsx', line: 57, reason: 'icon-only close button' },
    ...
    { file: '../components/layout/quick-switcher.tsx', line: 343, reason: 'icon-only clear button' },
    { file: '../components/layout/StatusBar.tsx', line: 61, reason: 'status dot background fill, not text' },
    { file: '../components/layout/Toolbar.tsx', line: 213, reason: 'icon-only disconnect button, hover to accent-red (semantic danger)' },
...
describe('M10 — hover:bg-surface-hover / hover:bg-surface-muted pair with primary text', () => {
  ...
  const ALLOWED: Array<{ file: string; line: number; reason: string }> = [
    ...
    { file: '../components/history/HistoryPanel.tsx', line: 149, reason: 'entry row container; query text already renders at text-primary' },
    ...
    { file: '../components/connection/connection-card.tsx', line: 65, reason: 'card container; name already primary, URI at text-secondary (AA-compliant on bg-muted)' },
    ...
    { file: '../components/history/HistoryPanel.tsx', line: 104, reason: 'icon-only clear-all button, hover to red (semantic danger), not primary' },
    { file: '../components/inspector/inspector-panel.tsx', line: 57, reason: 'icon-only close button, hover to secondary (still above its muted rest)' },
    { file: '../components/layout/Sidebar.tsx', line: 280, reason: 'row container; connection name already renders at text-primary' },
    { file: '../components/layout/Sidebar.tsx', line: 310, reason: 'row container; connection name already renders at text-primary' },
    { file: '../components/layout/Sidebar.tsx', line: 334, reason: 'row container; connection name already renders at text-primary' },
    { file: '../components/layout/Toolbar.tsx', line: 200, reason: 'icon-only reconnect button, hover to accent-yellow (semantic warning), not primary' },
    { file: '../components/layout/Toolbar.tsx', line: 213, reason: 'icon-only disconnect button, hover to accent-red (semantic danger), not primary' },
  ];
