...
describe('M10 — hover:bg-surface-hover / hover:bg-surface-muted pair with primary text', () => {
  ...
  const ALLOWED: Array<{ file: string; line: number; reason: string }> = [
    ...
    { file: '../components/layout/Sidebar.tsx', line: 278, reason: 'row container; connection name already renders at text-primary' },
    { file: '../components/layout/Sidebar.tsx', line: 308, reason: 'row container; connection name already renders at text-primary' },
    { file: '../components/layout/Sidebar.tsx', line: 332, reason: 'row container; connection name already renders at text-primary' },
