...
describe('M10 — hover:bg-surface-hover / hover:bg-surface-muted pair with primary text', () => {
  ...
  const ALLOWED: Array<{ file: string; line: number; reason: string }> = [
    ...
    { file: '../components/layout/Sidebar.tsx', line: 273, reason: 'row container; connection name already renders at text-primary' },
    { file: '../components/layout/Sidebar.tsx', line: 303, reason: 'row container; connection name already renders at text-primary' },
    { file: '../components/layout/Sidebar.tsx', line: 327, reason: 'row container; connection name already renders at text-primary' },
