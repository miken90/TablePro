...
- Click the **Filter** button in the status bar
- Press `Ctrl+Alt+F`

For a table tab the panel appears above the results grid; for a query tab it appears above the editor. The quick search field is automatically focused when the panel opens.
...
| Action | Shortcut |
|--------|----------|
| Toggle filter panel | `Ctrl+Alt+F` |
