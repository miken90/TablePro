---
title: Import & Export
description: Export to CSV, JSON, SQL, or XLSX. Import SQL files with transaction safety and progress tracking.
---

# Import & Export

Export data in four formats (CSV, JSON, SQL, XLSX), import SQL files with gzip support, and paste tabular data from the clipboard into the grid.
...
<Note>
**MongoDB**: SQL export is not available. Use CSV, JSON, or XLSX.
</Note>

<Note>
**Redis**: SQL export is not available. Use CSV, JSON, or XLSX.
</Note>
...
<Note>
**MongoDB**: SQL import is not available.
</Note>
...
<Steps>
  <Step title="Open Import Dialog">
    Click **File** > **Import**, or drag and drop a `.sql` / `.sql.gz` file onto the app.
  </Step>
