...
- **Preview SQL**: Click the **Preview SQL** button (eye icon) to review pending SQL statements before committing
- **Commit**: Click the **Commit** button (or press `Ctrl+S`) to apply all pending changes
- **Discard**: Click the **Discard** button to revert all pending changes
- **Undo/Redo**: Press `Ctrl+Z` to undo or `Ctrl+Shift+Z` to redo individual edits before committing
