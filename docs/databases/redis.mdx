...
<Tip>
Paste a `redis://:password@host:6379/0` or `rediss://` (TLS) URL into **Import from URL** on the connection form. See [Connection URL Reference](/databases/connection-urls#redis).
</Tip>
