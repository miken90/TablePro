...
TablePro supports five database systems:
...
<CardGroup cols={2}>
  ...
  <Card title="MongoDB" icon="leaf">
    MongoDB 5.0+ with MQL shell queries. Default port: 27017
  </Card>
</CardGroup>
...
| **Type** | Database type: MySQL, MariaDB, PostgreSQL, SQLite, or MongoDB |
...
| **Auth Database** | Authentication database (MongoDB only, default: `admin`) |
