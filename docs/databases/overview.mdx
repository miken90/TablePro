...
For PostgreSQL, MySQL/MariaDB, and SQL Server connections, configure SSL/TLS encryption via **SSL Mode**. MongoDB and Redis have their own TLS toggle (`tlsEnabled` for Redis; `mongodb+srv://` for MongoDB DNS-based TLS).
