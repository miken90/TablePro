...
TablePro hỗ trợ năm hệ thống cơ sở dữ liệu:
...
<CardGroup cols={2}>
  ...
  <Card title="MongoDB" icon="leaf">
    MongoDB 5.0+ với truy vấn MQL shell. Cổng mặc định: 27017
  </Card>
</CardGroup>
...
| **Type** | Loại cơ sở dữ liệu: MySQL, MariaDB, PostgreSQL, SQLite hoặc MongoDB |
...
Đối với MySQL, MariaDB, PostgreSQL và MongoDB:
...
| **Auth Database** | Cơ sở dữ liệu xác thực (chỉ MongoDB, mặc định: `admin`) |
